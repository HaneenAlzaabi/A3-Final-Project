...
# For creating and managing graphs
...
# Add 20 vertices (nodes) to the graph
for i in range(20):
    graph.add_vertex(i, names[i])

# Add 19 edges (connections between nodes) to the graph
for i in range(19):
...
# Add 10 more edges to create intersections
for _ in range(10):
